...
$sql = "SELECT propid, pname, paddress, pmaplink, pmobile, pprice, pdescription FROM properties WHERE pname LIKE '%$searchQuery%' ORDER BY propid DESC";
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav" style="margin-left:0;">
                    ...
                    <div class="sidebar-i">
                        ...
                        <li><a href="PropertyList.php"><i class="fa-solid fa-user" aria-hidden="true"> </i> <span style="margin-left:10px;">Pending Properties</span> </a></li>
                        <li><a href="WardenApprovedlist.php"><i class="fa-solid fa-user" aria-hidden="true"> </i> <span style="margin-left:10px;">Approved Properties</span> </a></li>
                        <li><a href="WardenRejectedlist.php"><i class="fa-solid fa-user" aria-hidden="true"> </i> <span style="margin-left:10px;">Rejected Properties</span> </a></li>
                        <li><a href="WardenLogout.php"><i class="fa-solid fa-newspaper" aria-hidden="true"> </i> <span style="margin-left:10px;">Logout</span> </a></li>
                    </div>
                </ul>
            </div>
            <!-- /#sidebar-wrapper -->
    ...
    ?>
            <div class="b-place">
                <div class="l-address-req">
                    ...
                    <div class="req-btn">
                        <a href="WardenPropertyDetails.php?propid=<?php echo $propid; ?>"><button type="button" class="rent-req-btn">More Details</button></a>
                    </div>
                </div>
            </div>
            <hr>
